 ...
 */
function hook_asset_injector_library_info_build_alter(&$library) {

}

/**
 * Use to add additional asset entity types.
 *
 * @return array
 *   Values of asset entities.
 */
function hook_asset_injector_asset_info() {
  return array(
    'css_injector',
    'js_injector',
  );
