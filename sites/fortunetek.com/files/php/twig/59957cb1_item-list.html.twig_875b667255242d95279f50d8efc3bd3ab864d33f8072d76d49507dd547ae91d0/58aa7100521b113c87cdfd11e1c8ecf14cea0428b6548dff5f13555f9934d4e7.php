...
/* themes/fortune_theme_/templates/dataset/item-list.html.twig */
class __TwigTemplate_7418701ad56aaab7eb7edf3113a46f79eb3588868aa6e8e31175cdf5f568c2ea extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        if (((isset($context["items"]) ? $context["items"] : null) || (isset($context["empty"]) ? $context["empty"] : null))) {
            ...
            if ((isset($context["items"]) ? $context["items"] : null)) {
                ...
                echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $this->getAttribute((isset($context["attributes"]) ? $context["attributes"] : null), "addClass", array(0 => "item-list__list"), "method"), "html", null, true));
                echo ">";
                // line 33
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 34
                    echo "<li";
                    echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $this->getAttribute($this->getAttribute($context["item"], "attributes", array()), "addClass", array(0 => "item-list__item"), "method"), "html", null, true));
                    echo ">";
    ...
    {
        return "themes/fortune_theme_/templates/dataset/item-list.html.twig";
    }
...
/*     {%- endif -%}*/
/*     {%- if items -%}*/
/*       <{{ list_type }}{{ attributes.addClass('item-list__list') }}>*/
/*         {%- for item in items -%}*/
/*           <li{{ item.attributes.addClass('item-list__item') }}>{{ item.value }}</li>*/
/*         {%- endfor -%}*/
/*       </{{ list_type }}>*/
/*     {%- else -%}*/
/*       {{- empty -}}*/
